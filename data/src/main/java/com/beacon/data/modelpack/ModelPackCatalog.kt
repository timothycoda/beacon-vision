...
object ModelPackCatalog {
    ...
    val all: List<ModelPackEntry> = listOf(
        ...
        ModelPackEntry(
            ...
            capability = "On-device Hausa speech (Meta MMS)",
            ramHint = "~2 GB RAM · ~109 MB storage",
            kind = ModelPackKind.Voice,
            sizeBytes = 114_013_880L,
            downloadUrl = "https://huggingface.co/willwade/mms-tts-multilingual-models-onnx/resolve/main/hau/model.onnx",
            sha256Hex = PLACEHOLDER_SHA256,
            fileName = "model.onnx",
            verifySizeOnly = true,
